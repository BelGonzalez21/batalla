...
function selectPosition(event){
    if(ship.quantity > 0){
        ...
        if(ship.position === "horizontal"){
            if((y + (ship.size - 1)) < 10){
                ...
                Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Selecciona una posición válida',
        ...
        Swal.fire({
            position: 'center',
            icon: 'info',
            title: 'Debes seleccionar un barco disponible',
            showConfirmButton: false,
            timer: 1800
          });
    }
...
function checkShot(event){
    ...
    if(matrixAttack[x][y] === "ship"){
        ...
        Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'Muy bien, acertaste. Vuelve a jugar',
            showConfirmButton: false,
            timer: 1800
          });        
        ...
        Swal.fire({
            position: 'center',
            icon: 'error',
            title: 'Mal! tu disparo cayó al agua',
            showConfirmButton: false,
            timer: 1800
          });
...
function shotPc(){
    ...
    if(matrix[x][y] === "ship"){
        ...
        Swal.fire({
            position: 'center',
            icon: 'error',
            title: 'El disparo del pc cayó al agua',
            showConfirmButton: false,
            timer: 1800
          });
        matrix[x][y] = "miss";
